...
public enum ResourceData {
	...
	COPPER("copper",2,true,1,false),
	TUNGSTEN("tungsten",1,true,3,false),
	TIN("tin",2,true,1,false),
	SULFUR("sulfur",3,false,2,false),
	NITER("niter",3,false,2,false),
	PHOSPHORUS("phosphorus",3,false,2,false),
	IRON("iron",0,true,0,true),
	GOLD("gold",0,true,0,true),
	PALADIUM("paladium",1,true,3,false);
	...
	ResourceData(String name, int oreQuantity, boolean metal, int harvestLevel, boolean vanilla) {
		this.name = name;
